Shader "Hidden/CascadedShadowMapping/Receiver" {
	...
	SubShader {
		...
		Pass {
			...
			float SampleShadowTexture(float4 wPos, fixed4 cascadeWeights)
			{
			...
			{			
				...
				float shadow = SampleShadowTexture(i.worldPos, weights);
